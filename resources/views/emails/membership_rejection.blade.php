                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="text-start">
                                ...
                                <p class="mb-0">We regret to inform you that your application for membership with Credit Cooperative Partners has been declined.</p>
                                <p class="mb-0">If you believe this to be in error or wish to discuss your application further, please contact us.</p>
                                <p class="mb-0">Sincerely,<br>Credit Cooperative Partners</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
