                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="text-start">
                                <p class="mb-0">Congratulations, {{ $name }}!</p>
                                <p class="mb-0">You are now a member of the Credit Cooperative Partners. Here are your login details:</p>
                                <p class="mb-0"><strong>Account Number:</strong> {{ $account_number }}</p>
                                <p class="mb-0"><strong>Default Password:</strong> {{ $defaultPassword }}</p>
