                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="text-start">
                                ...
                                <p class="mb-0">Please complete the change password process for the Cooperative Portal by entering the code provided below or by clicking on the link:</p>
                                <div class="text-center d-flex flex-column justify-content-center w-auto my-4">
                                    ...
                                    <a href="{{ $verificationUrl }}" class="btn btn-primary text-light">Reset Password</a>
                                </div>
