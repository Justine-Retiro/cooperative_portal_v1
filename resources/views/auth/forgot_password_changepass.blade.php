...
<div class="container-fluid body-login d-flex flex-column justify-content-center align-items-center">
    <form method="POST" action="{{ route('forgot.change.password') }}">
        @csrf
        @method('POST')
        <div class="row px-4">
            <div class="col-lg-12 px-md-5 w-100">
                ...
                <div class="row justify-content-center" >
                    <div class="col-lg-12 col-md-12 mx-5 my-2">
                        ...
                        <input type="password" class="form-control password_holder" placeholder="Confirm Password" name="password_confirmation" id="confirm_new_password" oninput="checkPasswordMatch()" required>
